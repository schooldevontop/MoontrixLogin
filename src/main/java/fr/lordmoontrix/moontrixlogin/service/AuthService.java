...
public final class AuthService {
    ...
    public CompletableFuture<AuthResult> verifyPassword(UUID uuid, String username, String password, String ip) {
        ...
        if (bruteForceProtector.isLocked(ipKey) || bruteForceProtector.isLocked(userKey)) {
        ...
        return userRepository.findByUsername(username).thenCompose(existing -> {
            ...
            if (!ok) {
                ...
                if (bruteForceProtector.isLockedNow(ipKey) || bruteForceProtector.isLockedNow(userKey)) {
    ...
    public CompletableFuture<AuthResult> completeLogin(UUID uuid, String ip) {
